...
REWRITE_BOT = os.environ.get("HOTSPOT_REWRITE_BOT", "gpt-5-mini")  # 便宜 + 中文 OK
...
def llm_rewrite(title: str, summary: str = "") -> str | None:
    """调 Poe gpt-5-mini · 把 hotspot 标题改写成干货 idea · 失败返回 None。"""
    try:
        from openai import OpenAI
    except ImportError:
        print("⚠ openai SDK 没装", file=sys.stderr)
        return None
    try:
