...
| 顺序 | 问题 | 对应字段 | 示例引导 |
|------|------|---------|---------|
| 1 | 你的公众号叫什么名字？主要做什么方向？ | `name` + `industry` | "比如'深夜情感站'，做情感/生活" |
| 2 | 主要写哪几个方向的内容？ | `topics` | "比如 亲密关系、自我成长、情绪管理" |
| 3 | 你希望文章是什么风格？ | `tone` | "温暖治愈？深夜倾诉？犀利洞察？像朋友聊天？" |
...
**快捷路径**：
- 如果用户直接甩了一段描述（如"我做情感自媒体，风格像KnowYourself"），直接从中提取所有能提取的字段，只补问缺的
