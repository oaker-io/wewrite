...
当 `content_style` 为"情绪"或 `industry` 包含"情感"时，选题评估额外适用以下规则：

### 情感相关度加成

以下话题方向与情感类账号高度相关，相关度评分时额外加分：

| 话题方向 | 加分 | 示例 |
|---------|------|------|
| 亲密关系/恋爱 | +2 | 恋爱脑、分手、暧昧关系、异地恋 |
| 自我成长/情绪管理 | +2 | 讨好型人格、内耗、自我和解 |
| 家庭/原生家庭 | +2 | 催婚、父母关系、代际差异 |
| 婚姻/两性 | +2 | 婚姻倦怠、沟通障碍、家务分配 |
| 孤独/社交 | +1 | 社恐、独居、搭子文化 |
| 职场情感 | +1 | 职场PUA、工作倦怠中的情感需求 |
| 社会情感话题 | +1 | 容貌焦虑、年龄焦虑、性别议题 |

### 情感切入价值评估

评估切入价值时，优先考虑：
- **情绪共鸣度**：读者看了是否会想到自己的经历 → 8-10 分
- **话题争议性**：是否有不同立场可以讨论（如"该不该为了爱情妥协"）→ 7-9 分
- **场景代入感**：是否能还原一个具体的情感场景 → 6-8 分
- **鸡汤度过高**：如果选题容易写成空洞的心灵鸡汤 → 扣 2 分

### 情感类常青选题

情感类常青选题来源：
- 人际关系中的经典困境（如"付出型人格怎么改"、"如何面对感情中的不安全感"）
- 自我成长方法论（如"怎么跟自己的情绪相处"、"如何建立健康的边界感"）
- 两性关系洞察（如"好的亲密关系长什么样"、"为什么越爱越累"）
