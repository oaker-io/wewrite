...
**问题**：AI 写情感文章容易变成两种极端——要么是空洞的心灵鸡汤（"要学会爱自己"），要么是冰冷的心理学科普。读者要的是"这个人懂我"的感觉，是具体的、温热的、带着体温的文字。

**执行步骤**：

1. **搜集真实情感素材**：
   ```
   WebSearch: "{情感话题} 真实故事 OR 读者投稿 OR 亲身经历"
   WebSearch: "{情感话题} site:zhihu.com OR site:douban.com"
   WebSearch: "{情感话题} 心理学 OR 研究 OR 调查"
   ```
   找以下 3 类素材（至少命中 2 类）：

   | 素材类型 | 示例 | 效果 |
   |---------|------|------|
   | **真实故事** | 知乎/豆瓣上的匿名倾诉、读者投稿 | 代入感 |
   | **心理洞察** | 依恋理论、情绪劳动、沉没成本效应 | 深度感 |
   | **数据锚定** | "某调查显示 62% 的人在分手后..." | 普遍感 |

2. **情感场景还原**：对框架中的"共鸣放大"段落，要求写作时包含：
   - 至少 2 个不同人物/场景的情感片段（不能只写一个人的故事）
   - 具体的对话、动作、表情（"她把手机翻过来扣在桌上"而非"她很难过"）
   - 一个大多数人经历过但从没说出口的微妙感受

3. **反鸡汤检查**：对框架中的"出路/和解"段落：
   - 禁止使用"要学会..."、"你应该..."、"只要...就..."等说教句式
   - 用"我后来发现..."或"有个朋友跟我说..."替代直接建议
   - 允许不给答案——"我也不知道什么是对的，但至少..."
   - 如果一句话听起来像朋友圈鸡汤文案，删掉重写

4. **输出**：在框架大纲的各段落下补充搜集到的情感素材和场景。

**检验**：读完你写的情感场景，能不能想到自己或身边某个人的经历？如果只是"好有道理"但没有画面感，共鸣不够。
